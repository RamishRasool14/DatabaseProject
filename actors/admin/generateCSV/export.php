...
// echo $val;
 ...
 elseif ( isset($_POST["export"]) && $val == 'Export Change Requests')
 {
    ...
    $output = fopen("php://output", "w");
    fputcsv($output, array(	"student_id" ,	"refrence_no"	, "info"));
 ...
 elseif ( isset($_POST["export"]) && $val == 'Export Courses')
 {
    ...
    $output = fopen("php://output", "w");
    fputcsv($output, array(	"course_id", "title", "dept_name", "credits", "cap"));
 ...
 elseif (isset($_POST["export"]) && $val == 'Export Departments')
 {
    ...
    $output = fopen("php://output", "w");
    fputcsv($output, array(	"dept_name", "building"));
 ...
 elseif (isset($_POST["export"]) && $val == 'Export Sections')
 {
    ...
    $output = fopen("php://output", "w");
    fputcsv($output, array("faculty_id","course_id","ta_id", "sec_id","semester","year","building" ,"room_number","time_slot_id"));
 ...
 elseif (isset($_POST["export"]) && $val == 'Export Students')
 {
    ...
    $output = fopen("php://output", "w");
    fputcsv($output, array("student_id"	,"name","password","address","dept_name","contact","email"
));
